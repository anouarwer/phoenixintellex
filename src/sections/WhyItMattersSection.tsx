...
export default function WhyItMattersSection({ className = '' }: WhyItMattersSectionProps) {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Phase 1: ENTRANCE (0-30%) - stronger motion
      scrollTl
        .fromTo(panel, 
          { x: '-70vw', opacity: 0 }, 
      ...
      >
        ...
        <div ref={bodyRef} className="max-w-[36vw] mb-10">
          <p className="text-[16px] text-[#A6B3D0] leading-relaxed mb-4">
            Reduce time-to-decision from weeks to hours.
          </p>
          <p className="text-[16px] text-[#A6B3D0] leading-relaxed">
            Align risk, treasury, and leadership around one consistent view of the portfolio.
          </p>
        </div>
        ...
        <button 
          ...
          className="btn-pill-primary flex items-center gap-2 w-fit"
        >
          Request a demo
          <ArrowRight size={18} />
        </button>
